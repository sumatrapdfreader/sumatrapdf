...
export async function testit(): Promise<void> {
  ...
  if (xfa.p1_draws !== 16) {
    throw new Error(
      `ad-hoc-xfa.pdf: expected p1_draws=16 on page 1 (pageArea + flowed + border + line + multiline + justify + tb/lr-tb + typeface + fontInfo alias + defaultTypeface), got p1_draws=${xfa.p1_draws}`,
    );
  }
  if (xfa.p1_borders !== 3) {
    throw new Error(
