...
make ZLIB_DIR=$EXT/zlib-1.2.3 JPEG_DIR=$EXT/jpeg6b JBIG2_DIR=$EXT/jbig2dec OPENJPEG_DIR=$EXT/openjpeg-1.3/libopenjpeg CFG=rel -j4
make ZLIB_DIR=$EXT/zlib-1.2.3 JPEG_DIR=$EXT/jpeg6b JBIG2_DIR=$EXT/jbig2dec OPENJPEG_DIR=$EXT/openjpeg-1.3/libopenjpeg CFG=dbg -j4
