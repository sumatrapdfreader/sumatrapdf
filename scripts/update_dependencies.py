...
def injectDependencyList(flatlist):
	...
	flatlist = "### the list below is auto-generated by update_dependencies.py\n" + flatlist + "\n"
	
	auto_generated_content_rx = r"(?ms)^### the list [^\n]+ update_dependencies\.py.*|\Z"
	content = re.sub(auto_generated_content_rx, flatlist.replace("\\", "\\\\"), content)
