...
enum HtmlTag {
    ...
    Tag_S, Tag_Section, Tag_Small, Tag_Span, Tag_Strike,
    Tag_Strong, Tag_Style, Tag_Sub, Tag_Subtitle, Tag_Sup,
    Tag_Table, Tag_Td, Tag_Th, Tag_Title, Tag_Tr,
    Tag_Tt, Tag_U, Tag_Ul, Tag_Video, Tag_NotFound
};
