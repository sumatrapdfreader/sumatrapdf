...
enum CssProp {
    ...
    Css_Margin_Left, Css_Margin_Right, Css_Margin_Top, Css_Max_Width, Css_Padding,
    Css_Padding_Bottom, Css_Padding_Left, Css_Padding_Right, Css_Padding_Top, Css_Page_Break_After,
    Css_Page_Break_Before, Css_Text_Align, Css_Text_Decoration, Css_Text_Indent, Css_Text_Underline,
