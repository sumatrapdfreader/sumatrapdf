...
enum CssProp {
    ...
    Css_Page, Css_Page_Break_After, Css_Page_Break_Before, Css_Rect, Css_Text_Align,
    Css_Text_Decoration, Css_Text_Indent, Css_Text_Underline, Css_Version, Css_White_Space,
    Css_Word_Wrap, Css_Unknown
};
