...
public:
    ...
    // When controls need to handle events generated by themselves,
    // they need to register for them like any other code
    // Over-ride this function to register/unregister for events
    // using EventMgr
