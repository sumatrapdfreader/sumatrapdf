...
MenuDef menuDefLang[] = {
    ...
    { _TRN("Finnish"),     IDM_LANG_FI },
    { _TRN("French"),      IDM_LANG_FR },
    { _TRN("German"),      IDM_LANG_DE },
    { _TRN("Greek"),       IDM_LANG_GR },
    { _TRN("Hungarian"),   IDM_LANG_HU },
    { _TRN("Italian"),     IDM_LANG_IT },
    { _TRN("Japanese"),    IDM_LANG_JA },
    { _TRN("Lithuanian"),  IDM_LANG_LT },
    { _TRN("Malaysian"),   IDM_LANG_MY },
    { _TRN("Norwegian"),   IDM_LANG_NO },
    { _TRN("Persian"),     IDM_LANG_FA },
    { _TRN("Polish"),      IDM_LANG_PL },
    { _TRN("Portuguese (Portugal)"),  IDM_LANG_PT },
    { _TRN("Russian"),     IDM_LANG_RU },
    { _TRN("Slovak"),      IDM_LANG_SK },
    { _TRN("Spanish"),     IDM_LANG_ES },
    { _TRN("Swedish"),     IDM_LANG_SV },
    { _TRN("Tamil"),       IDM_LANG_TA },
    { _TRN("Thai"),        IDM_LANG_TH },
    { _TRN("Turkish"),     IDM_LANG_TR },
    { _TRN("Vietnamese"),  IDM_LANG_VN },
    { SEP_ITEM,            0 },
