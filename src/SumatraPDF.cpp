...
fz_error BenchOpenXref(char *filename, char *password)
{
    fz_error error;
...
void BenchFile(TCHAR *filePath, TCHAR *pagesSpec)
{
    fz_error error;
    double timems;
    int pages;
