...
HRESULT STDMETHODCALLTYPE SumatraUIAutomationStartPageProvider::SetFocus() {
    return S_OK;
}
...
HRESULT STDMETHODCALLTYPE SumatraUIAutomationStartPageProvider::GetPropertyValue(PROPERTYID propertyId,
                                                                                 VARIANT* pRetVal) {
