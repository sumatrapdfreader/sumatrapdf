...
struct GlobalPrefs {
    ...
    bool tabsInTitlebar;
    // if true, the lightness of the caption's text color is inverted. Only
    // applies if UseTabs and TabsInTitlebar are true
    bool invertCaptionTextLightness;
...
static const FieldInfo gGlobalPrefsFields[] = {
    ...
    { offsetof(GlobalPrefs, invertCaptionTextLightness), Type_Bool,       false                                                                                                                 },
