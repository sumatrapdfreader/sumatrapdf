...
static struct {
    ...
    {"sublime_text.exe", "\"%f:%l:%c\"", BinaryDir, kRegCurrentVer "\\Uninstall\\Sublime Text 3_is1", "InstallLocation"},
    {"sublime_text.exe", "\"%f:%l:%c\"", BinaryPath, kRegCurrentVer "\\Uninstall\\Sublime Text 3_is1", "DisplayIcon"},
    {"sublime_text.exe", "\"%f:%l:%c\"", BinaryDir, kRegCurrentVer "\\Uninstall\\Sublime Text 2_is1", "InstallLocation"},
