...
constexpr COLORREF kLinkFollowHighlightCol = RGB(0xff, 0xf1, 0x00);
constexpr COLORREF kLinkFollowBadgeBgCol = RGB(0xd3, 0x2f, 0x2f);
constexpr COLORREF kLinkFollowBadgeTextCol = RGB(0xff, 0xff, 0xff);
