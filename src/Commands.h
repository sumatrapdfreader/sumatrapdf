...
enum {
    ...
    CmdToggleToolbarShowReadAloud = 422,
    CmdRemoveDeletedFilesFromHistory = 423,
    CmdCommandPaletteTOC = 424,
    CmdDebugToggleRenderInfo = 425,
    CmdConvertImageToPdf = 426,
    CmdExpandToCurrentPage = 427,
    CmdStartAutoScroll = 428,
    CmdAIChatWithClaudeCode = 429,
    CmdAIChatWithGrokBuild = 430,
    CmdAIChatWithOpenAICodex = 431,
    CmdTranslateSelectionWithGrokBuild = 432,
    CmdTranslateSelectionWithClaudeCode = 433,
    CmdTranslateSelectionWithOpenAICodex = 434,
    CmdFindToggleMatchWholeWord = 435,
    CmdGoToNextFavorite = 436,
    CmdGoToPrevFavorite = 437,
    CmdCreateAnnotImageFromClipboard = 438,
    CmdSetInverseSearch = 439,
    ...
    CmdSetDocumentColorsFollowTheme = 444,
    CmdTogglePreservePdfImages = 445,
    CmdToggleLightDarkTheme = 446,
    CmdChangeTheme = 447,
    CmdTranslateSelection = 448,
    CmdFavoriteShowInTab = 449,
    CmdTocExpandToLevel1 = 450,
    CmdTocExpandToLevel2 = 451,
    CmdTocExpandToLevel3 = 452,
    CmdTocCollapseSameLevel = 453,
    CmdToggleFavoritesSort = 454,
    CmdZoomFitHeight = 455,
    CmdDeleteFileAndOpenNext = 456,
    CmdShowGeneratedHTML = 457,
    CmdDeleteCachedFiles = 458,
