...
enum {
    ...
    CmdStopReadAloud = 428,
    CmdReadAloudFromTopPage = 429,
    CmdReadAloudSelection = 430,
    CmdToggleHoverPreview = 431,
    CmdRemoveDeletedFilesFromHistory = 432,
    CmdCommandPaletteTOC = 433,
    CmdDebugToggleRenderInfo = 434,
    CmdConvertImageToPdf = 435,
    CmdExpandToCurrentPage = 436,
    CmdStartAutoScroll = 437,
    CmdAIChatWithClaudeCode = 438,
    CmdAIChatWithGrokBuild = 439,
    CmdAIChatWithOpenAICodex = 440,
    CmdTranslateSelectionWithGrokBuild = 441,
    CmdTranslateSelectionWithClaudeCode = 442,
    CmdTranslateSelectionWithOpenAICodex = 443,
    CmdNone = 444,
