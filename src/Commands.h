...
enum {
    ...
    CmdReadAloudFromTopPage = 428,
    CmdReadAloudSelection = 429,
    CmdToggleHoverPreview = 430,
    CmdRemoveDeletedFilesFromHistory = 431,
    CmdCommandPaletteTOC = 432,
    CmdDebugToggleRenderInfo = 433,
    CmdConvertImageToPdf = 434,
    CmdExpandToCurrentPage = 435,
    CmdStartAutoScroll = 436,
    CmdAIChatWithClaudeCode = 437,
    CmdAIChatWithGrokBuild = 438,
    CmdAIChatWithOpenAICodex = 439,
    CmdTranslateSelectionWithGrokBuild = 440,
    CmdTranslateSelectionWithClaudeCode = 441,
    CmdTranslateSelectionWithOpenAICodex = 442,
    CmdNone = 443,
