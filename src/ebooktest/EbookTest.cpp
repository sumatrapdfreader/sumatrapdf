...
static const char *gSampleHtml = "<html><p align=justify><b>ClearType</b>, is <b>dependent</b> on the <i>orientation &amp; ordering</i> of the LCD stripes and possibly some other things unknown.</p> <p align='right'><em>Currently</em>, ClearType is implemented <hr> only for vertical stripes that are ordered RGB.</p> <p align=center>This might be a concern if you are using a tablet PC.</p> <p>Where the display can be oriented in any direction, or if you are using a screen that can be turned from landscape to portrait. The <strike>following example</strike> draws text with two <u>different quality</u> settings.</p> <p>This is a paragraph that should take at least two lines. With study and discreet inquiries, Abagnale picked up airline jargon and discovered that pilots could ride free anywhere in the world on any airline; and that hotels billed airlines direct and cashed checks issued by airline companies.</p><br><p>  And this is another paragraph tha we wrote today. Hiding out in a southern city, Abagnale learned that the state attorney general was seeking assistants. For nine months he practiced law, but when a real Harvard lawyer appeared on the scene, Abagnale figured it was time to move on.</p> On to the <b>next<mbp:pagebreak>page</b></html>";
