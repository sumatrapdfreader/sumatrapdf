...
AlignAttr FindAlignAttr(Str nameIn) {
    ...
    switch (key) {
        case CS4('c', 'e', 'n', 't'):
            if (6 == len && CS2('e', 'r') == STR2i(name + 4)) return AlignAttr::Center;
            break;
        case CS4('j', 'u', 's', 't'):
            if (7 == len && CS3('i', 'f', 'y') == STR3i(name + 4)) return AlignAttr::Justify;
            break;
        case CS4('l', 'e', 'f', 't'):
            if (4 == len) return AlignAttr::Left;
            break;
        case CS4('r', 'i', 'g', 'h'):
            if (5 == len && CS1('t') == STR1i(name + 4)) return AlignAttr::Right;
            break;
    }
