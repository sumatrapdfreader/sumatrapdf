...
ACCEL gAccelerators[] = {
    ...
    {FCONTROL | FVIRTKEY, '6', (WORD)IDM_VIEW_SINGLE_PAGE},
    {FCONTROL | FVIRTKEY, VK_NUMPAD6, (WORD)IDM_VIEW_SINGLE_PAGE},
    {FCONTROL | FVIRTKEY, '7', (WORD)IDM_VIEW_FACING},
    {FCONTROL | FVIRTKEY, VK_NUMPAD7, (WORD)IDM_VIEW_FACING},
    {FCONTROL | FVIRTKEY, '8', (WORD)IDM_VIEW_BOOK},
    {FCONTROL | FVIRTKEY, VK_NUMPAD8, (WORD)IDM_VIEW_BOOK},
