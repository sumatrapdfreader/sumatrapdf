...
ACCEL gAccelerators[] = {
    ...
    {FCONTROL | FVIRTKEY, VK_ADD, CmdViewZoomIn},
    {FSHIFT | FCONTROL | FVIRTKEY, VK_ADD, CmdViewRotateRight},
    {FCONTROL | FVIRTKEY, VK_OEM_PLUS, CmdViewZoomIn},
    ...
    {FCONTROL | FVIRTKEY, VK_SUBTRACT, CmdViewZoomOut},
    {FSHIFT | FCONTROL | FVIRTKEY, VK_SUBTRACT, CmdViewRotateLeft},
    {FCONTROL | FVIRTKEY, VK_OEM_MINUS, CmdViewZoomOut},
