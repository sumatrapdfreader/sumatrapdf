...
static const StructInfo gGlobalPrefsInfo = {
    ...
    "ckEdgeToTurnPage\0DisableLinks\0RememberViewOffsetOnPageTurn\0MouseWheelTurnsPage\0ShowDocumentFocusIndicator\0Sho"
    "wAnnotationNotification\0ShowTocPageNumbers\0ShowStartPage\0SidebarDx\0Scrollbars\0ScrollbarInSinglePage\0SmoothSc"
    "roll\0ScrollLineAmount\0PaddingAfterLastPage\0IgnoreDestinationZoom\0HighlightLinkDestination\0CitationHoverDelay"
    "\0ReadAloudVoiceId\0ReadAloudSpeed\0FastScrollOverScrollbar\0PreventSleepInFullscreen\0TabWidth\0Theme\0LastLightT"
    "heme\0LastDarkTheme\0DocumentColorsFollowTheme\0TocDy\0ToolbarCustomLayout\0ToolbarShowReadAloud\0ToolbarSize\0Tre"
    "eFontName\0TreeFontSize\0UIFontSize\0DisableAntiAlias\0EngineeringDrawingEnhance\0DisableAutoLinks\0UseSysColors\0"
    "UseTabs\0SelectionToolbar\0TabsMru\0CtrlTabSimple\0ZoomLevels\0ZoomIncrement\0\0FixedPageUI\0\0EBookUI\0\0ComicBoo"
    ...
    "can select and read (useful for drawings with many links); if false, clicking a link follows it\0if true, "
    "next/previous page keeps the same view position on the page instead of jumping to the top (useful when zoomed in "
    "on similarly sized pages)\0if true, one mouse-wheel notch goes to the next / previous page instead of scrolling; "
    "combine with RememberViewOffsetOnPageTurn to read zoomed-in pages without touching the keyboard. Alt + wheel "
    "still scrolls, Shift + wheel scrolls horizontally and Ctrl + wheel zooms\0if true, draw a focus ring around the "
    "document when it has keyboard focus (Tab to the page area)\0if true, show a tip when hovering an annotation (e.g. "
    ...
    "Adobe Reader's 'forbid the change of the current zoom factor during execution of Go to Destination actions'\0if "
    "true, following an internal link or bookmark flashes a highlight at the destination so you can see where you "
    "landed (a bibliography entry, figure, or named destination). The color and fade match ForwardSearch. Off when the "
    "destination is only a page with no position\0how long an internal-document link has to be hovered, in "
    "milliseconds, before a popup rendering the destination region (citation entry, figure, footnote) appears. -1 (the "
    ...
    "Comic Book UI\0\0customization options for image files UI\0\0customization options for CHM UI. UseFixedPageUI "
    "switches to the PDF-style view; FontName applies to that view\0\0customization options for Markdown UI. If "
    ...
    "means Auto\0remembered engine for Translate Selection: Google, DeepL, Grok Build, Claude Code, OpenAI Codex or "
