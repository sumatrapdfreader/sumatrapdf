...
static const StructInfo gGlobalPrefsInfo = {
    ...
    "ableLinks\0RememberViewOffsetOnPageTurn\0MouseWheelTurnsPage\0ShowDocumentFocusIndicator\0ShowAnnotationNotificati"
    "on\0ShowTocPageNumbers\0ShowStartPage\0SidebarDx\0Scrollbars\0ScrollbarInSinglePage\0SmoothScroll\0ScrollLineAmoun"
    "t\0PaddingAfterLastPage\0IgnoreDestinationZoom\0CitationHoverDelay\0ReadAloudVoiceId\0ReadAloudSpeed\0FastScrollOv"
    "erScrollbar\0PreventSleepInFullscreen\0TabWidth\0Theme\0LastLightTheme\0LastDarkTheme\0DocumentColorsFollowTheme\0"
    "TocDy\0ToolbarCustomLayout\0ToolbarShowReadAloud\0ToolbarSize\0TreeFontName\0TreeFontSize\0UIFontSize\0DisableAnti"
    "Alias\0EngineeringDrawingEnhance\0DisableAutoLinks\0UseSysColors\0UseTabs\0SelectionToolbar\0TabsMru\0CtrlTabSimpl"
    "e\0ZoomLevels\0ZoomIncrement\0\0FixedPageUI\0\0EBookUI\0\0ComicBookUI\0\0ImageUI\0\0ChmUI\0\0MarkdownUI\0\0HtmlUI"
    ...
    "the right)\0if true, draw a blue border around links in the document\0if true, a click (not a drag) on the left "
    "fifth of the page area goes to the previous page and a click on the right fifth goes to the next page (reversed "
    "in manga / right-to-left mode). Links, annotations and presentation-mode clicks are unchanged\0if true, document "
    "links are ignored so you can select and read (useful for drawings with many links); if false, clicking a link "
    "follows it\0if true, next/previous page keeps the same view position on the page instead of jumping to the top "
    "(useful when zoomed in on similarly sized pages)\0if true, one mouse-wheel notch goes to the next / previous page "
    "instead of scrolling; combine with RememberViewOffsetOnPageTurn to read zoomed-in pages without touching the "
    "keyboard. Alt + wheel still scrolls, Shift + wheel scrolls horizontally and Ctrl + wheel zooms\0if true, draw a "
    "focus ring around the document when it has keyboard focus (Tab to the page area)\0if true, show a tip when "
    "hovering an annotation (e.g. \"Highlight annotation. Ctrl+click to edit.\")\0if true, show page numbers (labels) "
