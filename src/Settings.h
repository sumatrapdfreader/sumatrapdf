...
static const StructInfo gGlobalPrefsInfo = {
    ...
    "SearchUIFloating\0ShowFavorites\0SortFavoritesByName\0ShowToc\0SidebarOnRight\0ShowLinks\0DisableLinks\0RememberVi"
    "ewOffsetOnPageTurn\0ShowDocumentFocusIndicator\0ShowAnnotationNotification\0ShowTocPageNumbers\0ShowStartPage\0Sid"
    "ebarDx\0Scrollbars\0ScrollbarInSinglePage\0SmoothScroll\0PaddingAfterLastPage\0IgnoreDestinationZoom\0CitationHove"
    "rDelay\0ReadAloudVoiceId\0ReadAloudSpeed\0FastScrollOverScrollbar\0PreventSleepInFullscreen\0TabWidth\0Theme\0Last"
    "LightTheme\0LastDarkTheme\0DocumentColorsFollowTheme\0TocDy\0ToolbarCustomLayout\0ToolbarShowReadAloud\0ToolbarSiz"
    "e\0TreeFontName\0TreeFontSize\0UIFontSize\0DisableAntiAlias\0EngineeringDrawingEnhance\0DisableAutoLinks\0UseSysCo"
    "lors\0UseTabs\0SelectionToolbar\0TabsMru\0CtrlTabSimple\0ZoomLevels\0ZoomIncrement\0\0FixedPageUI\0\0EBookUI\0\0Co"
    "micBookUI\0\0ImageUI\0\0ChmUI\0\0MarkdownUI\0\0HtmlUI\0\0ClaudeCode\0\0GrokBuild\0\0CodexBuild\0\0AntiGravity\0\0A"
    "IChatSidebarDx\0\0TranslateToLang\0TranslateFromLang\0TranslateEngine\0\0Annotations\0\0ExternalViewers\0\0Forward"
    "Search\0\0PrinterDefaults\0\0Fullscreen\0\0SelectionHandlers\0\0Shortcuts\0\0Themes\0\0TabGroups\0\0CustomScreenDP"
    "I\0\0\0DefaultPasswords\0UiLanguage\0VersionToSkip\0WindowState\0WindowPos\0SearchUIWindowPos\0FileStates\0Session"
    "Data\0ReopenOnce\0TimeOfLastUpdateCheck\0OpenCountWeek\0PropWinPos\0CheckForUpdates\0\0",
    ...
    "the right)\0if true, draw a blue border around links in the document\0if true, document links are ignored so you "
    ...
    "on similarly sized pages)\0if true, draw a focus ring around the document when it has keyboard focus (Tab to the "
    "page area)\0if true, show a tip when hovering an annotation (e.g. \"Highlight annotation. Ctrl+click to "
    ...
    "Palenight, System\0the light theme the light/dark toggle and the System theme switch to\0the dark theme the "
    "light/dark toggle and the System theme switch to\0how MuPDF-rendered documents (PDF, XPS, DjVu, EPUB, MOBI, FB2, "
    "CBZ, images, etc.) use UI / FixedPageUI colors for the page. Values: off (document's own colors; default); smart "
