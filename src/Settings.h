...
static const StructInfo gGlobalPrefsInfo = {
    ...
    "h\0Theme\0PdfDocumentColorMode\0TocDy\0ToolbarSize\0TreeFontName\0TreeFontSize\0UIFontSize\0DisableAntiAlias\0Engi"
    "neeringDrawingEnhance\0DisableAutoLinks\0UseSysColors\0UseTabs\0TabsMru\0ZoomLevels\0ZoomIncrement\0\0FixedPageUI"
    "\0\0EBookUI\0\0ComicBookUI\0\0ImageUI\0\0ChmUI\0\0MarkdownUI\0\0ClaudeCode\0\0GrokBuild\0\0CodexBuild\0\0AIChatSid"
    "ebarDx\0\0TranslateToLang\0\0Annotations\0\0ExternalViewers\0\0ForwardSearch\0\0PrinterDefaults\0\0Fullscreen\0\0S"
    "electionHandlers\0\0Shortcuts\0\0Themes\0\0TabGroups\0\0CustomScreenDPI\0\0\0DefaultPasswords\0UiLanguage\0Version"
    "ToSkip\0WindowState\0WindowPos\0SearchUIWindowPos\0FileStates\0SessionData\0ReopenOnce\0TimeOfLastUpdateCheck\0Ope"
    "nCountWeek\0PropWinPos\0CheckForUpdates\0\0",
    ...
    "tab\0Valid themes: light, dark, darker\0Valid values: auto, black, light\0if both favorites and bookmarks parts "
    "of sidebar are visible, this is the height of bookmarks (table of contents) part\0height of toolbar\0font name "
    "for bookmarks and favorites tree views. automatic means Windows default\0font size for bookmarks and favorites "
    "tree views. 0 means Windows default\0over-ride application font size. 0 means Windows default\0if true, disables "
    ...
    "opened in tabs instead of new windows\0if true, Ctrl+Tab and Ctrl+Shift+Tab show the tab switcher in most "
    "recently used order instead of tab-strip order\0sequence of zoom levels when zooming in/out; all values must lie "
    "between 8.33 and 6400\0zoom step size in percents relative to the current zoom level. if zero or negative, the "
    "values from ZoomLevels are used instead\0\0customization options for PDF, XPS, DjVu and PostScript "
