...
static const StructInfo gGlobalPrefsInfo = {
    ...
    "roll\0ScrollLineAmount\0PaddingAfterLastPage\0IgnoreDestinationZoom\0CitationHoverDelay\0ReadAloudVoiceId\0ReadAlo"
    "udSpeed\0FastScrollOverScrollbar\0PreventSleepInFullscreen\0TabWidth\0Theme\0LastLightTheme\0LastDarkTheme\0Docume"
    "ntColorsFollowTheme\0TocDy\0ToolbarCustomLayout\0ToolbarShowReadAloud\0ToolbarSize\0TreeFontName\0TreeFontSize\0UI"
    "FontSize\0DisableAntiAlias\0EngineeringDrawingEnhance\0DisableAutoLinks\0UseSysColors\0UseTabs\0SelectionToolbar\0"
    "TabsMru\0CtrlTabSimple\0ZoomLevels\0ZoomIncrement\0\0FixedPageUI\0\0EBookUI\0\0ComicBookUI\0\0ImageUI\0\0ChmUI\0\0"
    "MarkdownUI\0\0HtmlUI\0\0ClaudeCode\0\0GrokBuild\0\0CodexBuild\0\0AntiGravity\0\0AIChatSidebarDx\0\0TranslateToLang"
    "\0TranslateFromLang\0TranslateEngine\0\0Annotations\0\0ExternalViewers\0\0ForwardSearch\0\0PrinterDefaults\0\0Full"
    "screen\0\0SelectionHandlers\0\0Shortcuts\0\0Themes\0\0TabGroups\0\0CustomScreenDPI\0\0\0DefaultPasswords\0UiLangua"
    "ge\0VersionToSkip\0WindowState\0WindowPos\0SearchUIWindowPos\0FileStates\0SessionData\0ReopenOnce\0TimeOfLastUpdat"
    ...
    "region (citation entry, figure, footnote) appears. -1 (the default) disables the popup; set a positive value like "
    "300 to enable it\0voice id for Read Aloud text-to-speech; empty or unset means system default. Voice ids match "
    "those used internally by the Read Aloud Voice menu (WinRT voice id or SAPI token id)\0playback speed multiplier "
    "for Read Aloud text-to-speech (0.5 .. 3.0), 1 is normal speed; can also be changed from the Read Aloud playback "
    ...
    "instead of tab-strip order\0if true, Ctrl+Tab and Ctrl+Shift+Tab immediately switch to the next / previous tab in "
    "tab-strip order (the behavior before version 3.6) instead of showing the tab switcher\0sequence of zoom levels "
    "when zooming in/out; values must lie between 8.33 and 1000000 (the largest one becomes the maximum zoom, which is "
