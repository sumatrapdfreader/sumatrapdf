...
static const StructInfo gGlobalPrefsInfo = {
    ...
    "SearchUIFloating\0ShowFavorites\0SortFavoritesByName\0ShowToc\0ShowLinks\0DisableLinks\0RememberViewOffsetOnPageTu"
    "rn\0ShowDocumentFocusIndicator\0ShowAnnotationNotification\0ShowTocPageNumbers\0ShowStartPage\0SidebarDx\0Scrollba"
    "rs\0ScrollbarInSinglePage\0SmoothScroll\0PaddingAfterLastPage\0IgnoreDestinationZoom\0CitationHoverDelay\0ReadAlou"
    "dVoiceId\0ReadAloudSpeed\0FastScrollOverScrollbar\0PreventSleepInFullscreen\0TabWidth\0Theme\0LastLightTheme\0Last"
    "DarkTheme\0DocumentColorsFollowTheme\0TocDy\0ToolbarCustomLayout\0ToolbarShowReadAloud\0ToolbarSize\0TreeFontName"
    "\0TreeFontSize\0UIFontSize\0DisableAntiAlias\0EngineeringDrawingEnhance\0DisableAutoLinks\0UseSysColors\0UseTabs\0"
    "SelectionToolbar\0TabsMru\0CtrlTabSimple\0ZoomLevels\0ZoomIncrement\0\0FixedPageUI\0\0EBookUI\0\0ComicBookUI\0\0Im"
    "ageUI\0\0ChmUI\0\0MarkdownUI\0\0HtmlUI\0\0ClaudeCode\0\0GrokBuild\0\0CodexBuild\0\0AntiGravity\0\0AIChatSidebarDx"
    "\0\0TranslateToLang\0TranslateFromLang\0TranslateEngine\0\0Annotations\0\0ExternalViewers\0\0ForwardSearch\0\0Prin"
    ...
    "with many links); if false, clicking a link follows it\0if true, next/previous page keeps the same view position "
    "on the page instead of jumping to the top (useful when zoomed in on similarly sized pages)\0if true, draw a focus "
    "ring around the document when it has keyboard focus (Tab to the page area)\0if true, show a tip when hovering an "
    "annotation (e.g. \"Highlight annotation. Ctrl+click to edit.\")\0if true, show page numbers (labels) "
