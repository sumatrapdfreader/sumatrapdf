...
void Align::SetBounds(Rect bounds) {
  ...
  Length x = scale(bminx, this->HAlign - AlignEnd, twm) +
  ...
  Length y = scale(bminy, this->VAlign - AlignEnd, twm) +
...
// TODO: implement me
bool IsExpand(Kind) { return false; }
bool IsExpand(ILayout*) { return false; }

bool IsLabeL(Kind) { return false; }
bool IsLabel(ILayout*) { return false; }

bool IsCheckbox(Kind) { return false; }
bool IsCheckbox(ILayout*) { return false; }
