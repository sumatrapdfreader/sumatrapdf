...
static ToolbarButtonInfo gToolbarButtons[] = {
    ...
    {13, CmdViewRotateLeft, _TRN("Rotate Left"), 0},
    {14, CmdViewRotateRight, _TRN("Rotate Right"), 0},
...
void CreateToolbar(WindowInfo* win) {
    ...
    if (useSvg) {
        ...
        hbmp = LoadExternalBitmap(GetModuleHandle(nullptr), L"toolbar_13.bmp", IDB_TOOLBAR, useDibSection);
