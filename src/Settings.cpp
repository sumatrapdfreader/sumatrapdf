...
static uint8_t gAdvancedSettings2Default[] = {
  ...
  0x80, 0x80, 0x90, 0x10, // uint32_t version = 0x2040000
  0x00, // bool traditionalEbookUI = False
  0x00, // bool escToExit = False
  0x80, 0xe4, 0xff, 0x07, // uint32_t logoColor = 0xfff200
  0x04, // PaddingSettings * pagePadding = 0x4
  0x08, // PaddingSettings * fooPadding = 0x8
  0x00, // PaddingSettings * foo2Padding = 0x0
  0x0c, // ForwardSearchSettings * forwardSearch = 0xc
  0x00, // PaddingSettings * foo3Padding = 0x0

  // PaddingSettings offset: 0xf
  ...
  // ForwardSearchSettings offset: 0x1b
