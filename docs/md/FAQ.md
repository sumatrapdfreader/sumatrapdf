...
Yes — **pre-release 3.7+** adds Read Aloud (`Ctrl + K`, `Read Aloud` command in [Command Palette](Command-Palette.md)) using Windows text-to-speech. See [Read Aloud (TTS)](Read-Aloud.md).
