...
- `CmdAdvancedOptions` is gone: **Settings → Advanced Options...** and the palette's **Advanced Options...** run `CmdAdvancedSettings`, the dialog. A shortcut definition naming `CmdAdvancedOptions` still works
