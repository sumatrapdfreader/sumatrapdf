...
- The floating selection toolbar uses the PDF annotation toolbar’s icons for annotation actions. Its built-in buttons can be chosen and reordered with `SelectionToolbarLayout`, the same idea as `ToolbarCustomLayout` (discussion #6015)
