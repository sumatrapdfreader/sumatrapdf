...
- smoother mouse-wheel scrolling when `SmoothScroll = true`: continuous exponential chase of the wheel target (no ease-out restart stutter), sub-pixel accumulation, and a 1 ms timer period while animating
