...
- the annotation editor's list of annotations grows with the window instead of being a fixed 5 (or 14) lines, so making the window taller shows more annotations rather than more empty space (fixes #3769)
