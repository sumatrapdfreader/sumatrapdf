...
- Home page thumbnails use a cover image stored next to the document with the same base name (`Book.jpg`, `.jpeg` or `.png` beside `Book.epub`), the way Calibre saves covers, instead of rendering page 1 (fixes #6236)
