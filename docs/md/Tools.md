...
The same page-delete operations are also available in the app: `Ctrl + K`, `Delete Pages From PDF` command in [Command Palette](Command-Palette.md), or context menu **Document → Delete Pages From PDF**.
