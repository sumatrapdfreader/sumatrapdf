...
| Discard unsaved changes  | `CmdDiscardChanges` (tab context menu **Discard changes**, or `Ctrl + K`, `Discard Changes` command in Command Palette) — reloads the file from disk |
