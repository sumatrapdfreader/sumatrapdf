...
#ifndef LIBHEIF_UNC_DECODER_BYTEALIGN_COMPONENT_INTERLEAVE_H
#define LIBHEIF_UNC_DECODER_BYTEALIGN_COMPONENT_INTERLEAVE_H
...
class unc_decoder_bytealign_component_interleave : public unc_decoder
{
public:
...
class unc_decoder_factory_bytealign_component_interleave : public unc_decoder_factory
{
private:
