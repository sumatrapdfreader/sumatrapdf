...
/* SumatraPDF: upstream 1.3.2 changed these to "#if HAVE_*_H-0" which trips
   C4668 (undefined macro in #if) under our warnings-as-error build; revert to
   the 1.3.1 "#ifdef" form (identical behavior when the macro is undefined). */
